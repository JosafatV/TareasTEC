...
def parse_input ():
    ...
    job_relations = [[0,1,100], [1,2,100], [2,3,100]]
    ...
    for task_id in range (len(job_lists)):
        ...
        master_string += job_lists[task_id][0] + " earliest start 0 deadline 10000 " + "input_vol " + str(job_lists[task_id][1]) + " output_vol " +  str(job_lists[task_id][2]) + newline
